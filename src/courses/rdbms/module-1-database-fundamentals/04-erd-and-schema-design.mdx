...
➡️ នេះគឺជាទំនាក់ទំនង (Relationship) ប្រភេទ **One-to-Many**។

---

## 🔗 Cardinality (ទំហំនៃទំនាក់ទំនង)

នៅក្នុងការរចនា Database យើងត្រូវដឹងអោយច្បាស់ពីទំហំនៃទំនាក់ទំនង ដែលយើងហៅថា **Cardinality**:

1. **One-to-One (1:1):** 
   *ឧទាហរណ៍៖ User ម្នាក់មាន Profile តែមួយគត់។*
2. **One-to-Many (1:N):** 
   *ឧទាហរណ៍៖ User ម្នាក់អាចទិញទំនិញ (Orders) ច្រើនដង។* 
   `User 1 ───── N Orders`
3. **Many-to-Many (N:M):** 
   *ឧទាហរណ៍៖ Order មួយអាចមានទំនិញ (Products) ច្រើន ហើយ Product មួយប្រភេទអាចស្ថិតនៅក្នុង Orders ច្រើន។*
   `Orders N ───── M Products`

> ⚠️ **ចំណាំសំខាន់:** RDBMS មិនអាចបង្កើតទំនាក់ទំនង Many-to-Many ដោយផ្ទាល់បានទេ! យើងត្រូវតែបង្កើតតារាងកណ្តាលមួយ (Junction Table)។ ដូច្នេះទំនាក់ទំនង `Orders` និង `Products` ត្រូវផ្សារភ្ជាប់គ្នាដោយតារាងកណ្តាលឈ្មោះថា `OrderItems`។
