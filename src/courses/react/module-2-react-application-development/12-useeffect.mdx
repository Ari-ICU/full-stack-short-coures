...
description: កែតម្រូវការយល់ច្រឡំដ៏ធំបំផុតនៅក្នុង React! រៀនថា useEffect មិនមែនជា Lifecycle ទេ ប៉ុន្តែវាជាឧបករណ៍សម្រាប់ធ្វើសមកាលកម្ម (Synchronize) ជាមួយប្រព័ន្ធខាងក្រៅ។
objectives:
...
quiz:
  - question: "តើគោលបំណងចម្បងបំផុតនៃ `useEffect` គឺជាអ្វី?"
    options:
      - "\"វាត្រូវបានប្រើប្រាស់ជំនួសអោយពាក្យបញ្ជា componentDidMount, componentDidUpdate, និង componentWillUnmount ដើម្បីដឹងថាទំព័រ Load ចប់។\""
      - "\"វាត្រូវបានប្រើដើម្បីភ្ជាប់និងធ្វើសមកាលកម្ម (Synchronize) Component របស់អ្នកទៅនឹងប្រព័ន្ធខាងក្រៅ (ដូចជា API, Browser Events, ឫ Timers) ដែល React មិនអាចគ្រប់គ្រងបានដោយផ្ទាល់។\""
      - "\"វាត្រូវបានប្រើសម្រាប់ផ្លាស់ប្តូរ State អោយបានលឿនជាងមុន\""
      - "\"វាត្រូវបានប្រើសម្រាប់គូរ UI\""
    correctAnswer: 2
    explanation: "ការគិតថា `useEffect` ជា 'Lifecycle' (កាលពីសម័យ Class Component) គឺជាកំហុសដ៏ធំ ដែលនឹងធ្វើអោយអ្នកសរសេរកូដរញ៉េរញ៉ៃ (Spaghetti Effect)។ អ្នកគួរគិតថាវាជាខ្សែភ្លើងដែលតភ្ជាប់ពីកូដ React សុទ្ធសាធ ទៅកាន់ពិភពខាងក្រៅ (ឧ. ការហៅ Network ឫស្តាប់ការ Scroll)។"
---
