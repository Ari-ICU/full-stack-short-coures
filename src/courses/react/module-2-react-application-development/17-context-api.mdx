---
title: Context API
description: ដោះស្រាយបញ្ហា 'Prop Drilling' ដោយប្រើប្រាស់ Context API ដើម្បីចែកចាយទិន្នន័យទៅកាន់ទូទាំង Component Tree ដោយមិនចាំបាច់បញ្ជូនបន្តៗគ្នា។
objectives:
  - យល់ពីបញ្ហា Prop Drilling នៅក្នុង React
  - ចេះបង្កើត Context, Provider, និងការប្រើប្រាស់ `useContext`
  - ដឹងពីករណីដែលគួរ និងមិនគួរប្រើប្រាស់ Context (មិនមែនជា Global State គ្រប់រឿងនោះទេ)
...
quiz:
  - question: "តើ Context API ត្រូវបានបង្កើតឡើងដើម្បីដោះស្រាយបញ្ហាអ្វីចម្បងជាងគេ?"
    options:
      ...
      - "\"បញ្ហា Prop Drilling (ការបញ្ជូនទិន្នន័យពីឪពុក ទៅកូន ទៅចៅ ទៅចៅទួត បន្តបន្ទាប់គ្នាជាច្រើនដំណាក់កាល ដោយComponentកណ្តាលមិនត្រូវការទិន្នន័យនោះសោះ)\""
      - "\"ការគ្រប់គ្រង Database\""
    correctAnswer: 3
    explanation: "Context គឺជា 'រន្ធបញ្ជូនទិន្នន័យសម្ងាត់ (Teleport)' ដែលអនុញ្ញាតអោយអ្នកបញ្ជូនទិន្នន័យពីកំពូល ទៅដល់បាតក្រោមបានដោយផ្ទាល់ ដោយមិនចាំបាច់ឆ្លងកាត់អ្នកដែលនៅកណ្តាលរញ៉េរញ៉ៃឡើយ។"
---
