---
title: Custom Hooks
description: រៀនពីរបៀបបង្កើត Hooks ផ្ទាល់ខ្លួន (Custom Hooks) ដើម្បីទាញយក State និង Logic ដែលសរសេរដដែលៗ ទៅជាកញ្ចប់កូដដែលអាចយកទៅប្រើប្រាស់ឡើងវិញបានយ៉ាងស្អាតបាត។
objectives:
...
quiz:
  - question: "តើគោលបំណងចម្បងនៃការបង្កើត Custom Hook គឺជាអ្វី?"
    options:
      ...
      - "\"ដើម្បីទាញយកកូដតក្កវិទ្យា (Logic) ដែលមានផ្ទុក State និង Effect ចេញពី Component ធ្វើអោយវាក្លាយជាកញ្ចប់កូដដែលអាចយកទៅហៅប្រើនៅទីកន្លែងផ្សេងៗទៀតបាន។\""
      - "\"ដើម្បីជំនួសការប្រើប្រាស់ CSS\""
    correctAnswer: 3
    explanation: "Custom Hooks មិនមែនបង្កើតឡើងគ្រាន់តែដើម្បីសរសេរកូដធម្មតាទេ តែវាប្រើសម្រាប់សរសេរកូដដែលមានជាប់ទាក់ទងនឹង React (ដូចជា `useState`, `useEffect`) ដើម្បីយកទៅបំពាក់លើ Components ជាច្រើនអោយដំណើរការមុខងារដូចៗគ្នាបាន។"
---
