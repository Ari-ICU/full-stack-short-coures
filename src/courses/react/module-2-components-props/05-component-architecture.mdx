...
description: >-
  ឈានចូលដល់ការសរសេរកូដកម្រិតអាជីព! រៀនពីរចនាសម្ព័ន្ធ Folder ដែលត្រឹមត្រូវ
  (Folder Structure), ការបំបែកតួនាទី Components និងការលើក State ឡើងលើ (Lifting
  State Up)។
objectives:
...
quiz:
  - question: តើគោលការណ៍ 'Lifting State Up' មានន័យដូចម្តេច?
    options:
      ...
      - >-
        "ការផ្លាស់ទី State ពី Component កូនៗ ទៅកាន់ Component ឪពុករបស់វា
        ដើម្បីអោយកូនៗទាំងនោះអាចចែករំលែកទិន្នន័យគ្នាប្រើប្រាស់បាន។"
      - '"ការប្រើប្រាស់ Redux ជំនួសអោយ useState"'
    correctAnswer: 3
    explanation: >-
      ដោយសារតែទិន្នន័យក្នុង React ហូរពីលើចុះក្រោម (One-way) ប្រសិនបើបងប្អូន ២
      (កូនទាំង២) ចង់ចែករំលែកទិន្នន័យគ្នា ពួកវាមិនអាចបញ្ជូនអោយគ្នាផ្ទាល់បានទេ!
      ដំណោះស្រាយគឺត្រូវដក State នោះយកទៅទុកនៅឯឪពុករបស់វា
      រួចទើបឪពុកចែកចាយមកអោយកូនទាំង២តាមរយៈ Props វិញ។
---
