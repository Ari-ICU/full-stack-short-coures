...
description: >-
  ស្វែងយល់ពីអ្វីទៅជា React ហេតុអ្វីបានជាវាពេញនិយមបំផុត
  និងរបៀបដែលវាផ្លាស់ប្តូរការអភិវឌ្ឍន៍វេបសាយ (Modern Web Development)។
objectives:
...
quiz:
  - question: តើអ្វីទៅជា Single Page Application (SPA) ដែល React ប្រើប្រាស់?
    options:
      ...
      - >-
        "វាជាវេបសាយដែលផ្ទុក HTML តែមួយដងគត់ (index.html)
        ហើយរាល់ការចុចទៅទំព័រផ្សេងៗ គឺវាគ្រាន់តែប្តូរកូដនៅខាងក្នុងដោយប្រើ
        JavaScript ជំនួសអោយការ Refresh វេបសាយទាំងមូល។"
      - '"វាជាវេបសាយដែលរចនាឡើងសម្រាប់តែទូរស័ព្ទដៃប៉ុណ្ណោះ"'
      - '"វាជាវេបសាយដែលសរសេរដោយប្រើតែភាសា HTML មួយមុខគត់"'
    correctAnswer: 2
    explanation: >-
      SPA គឺជាអាថ៌កំបាំងដែលធ្វើអោយវេបសាយ React មានល្បឿនលឿនដូចកម្មវិធីលើទូរស័ព្ទ
      (Native Apps) ព្រោះវាមិនចាំបាច់ Load ទំព័រថ្មីរាល់ពេលដែលអ្នកចុចលើ Link
      ណាមួយឡើយ។
---
