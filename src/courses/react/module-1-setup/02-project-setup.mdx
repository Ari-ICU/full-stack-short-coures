...
description: >-
  រៀនពីរបៀបបង្កើតគម្រោង React ថ្មីដោយប្រើប្រាស់ Vite ស្វែងយល់ពីរចនាសម្ព័ន្ធ
  Folder និងដឹងពីភាពខុសគ្នារវាងឧបករណ៍ Build Tool និង React។
objectives:
...
quiz:
  - question: តើអ្វីទៅជាភាពខុសគ្នារវាង Vite និង React?
    options:
      ...
      - >-
        "React គឺជាបណ្ណាល័យសម្រាប់សរសេរកូដ UI ចំណែកឯ Vite គឺជាឧបករណ៍ (Build
        Tool) សម្រាប់វេចខ្ចប់កូដ React នោះអោយដំណើរការលឿននៅលើ Browser។"
      - '"React ប្រើប្រាស់ភាសា JavaScript ចំណែក Vite ប្រើប្រាស់ភាសា Python"'
    correctAnswer: 3
    explanation: >-
      អ្នកអភិវឌ្ឍន៍ថ្មីៗតែងតែយល់ច្រឡំថា Vite គឺជា React។ តាមពិត Vite
      គឺជាឧបករណ៍វេចខ្ចប់ដ៏មានល្បឿនលឿន (ជំនួសអោយ Webpack ឬ Create React App)
      ដែលអាចវេចខ្ចប់កូដផ្សេងៗជាច្រើនក្រៅពី React ដូចជា Vue ឫ Svelte ផងដែរ។
---
