...
description: >-
  រៀនពីរបៀបការពារទំព័រ (ឧ. ទំព័រ Admin) មិនអោយអ្នកដែលមិនទាន់ Login អាចចូលមើលបាន
  និងយល់ពីការបែងចែកសិទ្ធិ (Authorization)។
objectives:
...
quiz:
  - question: >-
      តើការដាក់កូដរារាំងទំព័រមិនអោយចូល (Protected Routes) នៅក្នុង React
      (Frontend) ផ្តល់សុវត្ថិភាព ១០០% កុំអោយ Hacker លួចយកទិន្នន័យបានដែរឬទេ?
    options:
      - '"ផ្តល់សុវត្ថិភាព ១០០%"'
      - >-
        "មិនផ្តល់សុវត្ថិភាពទេ! កូដ Frontend គ្រាន់តែជួយរារាំង UI
        (បទពិសោធន៍អ្នកប្រើប្រាស់) ប៉ុណ្ណោះ។ បើ API Backend មិនបានការពារទេ Hacker
        អាចទាញយកទិន្នន័យតាមរយៈ Postman ឫ Terminal បានយ៉ាងងាយ។"
      - '"ផ្តល់សុវត្ថិភាពបាន លុះត្រាតែអ្នកប្រើ Redux"'
      - '"ផ្តល់សុវត្ថិភាព លុះត្រាតែកូដត្រូវបាន Compile"'
    correctAnswer: 2
    explanation: >-
      ច្បាប់មាសនៃ Web Security: **កុំទុកចិត្ត Frontend (Never trust the
      client)!** Protected Route នៅក្នុង React គឺគ្រាន់តែជួយអោយការចុចចុះឡើង (UX)
      មានភាពរលូន (បើមិនទាន់ Login អោយលោតទៅទំព័រ Login វិញ)។
      ការការពារទិន្នន័យពិតប្រាកដគឺឋិតនៅលើ Middleware របស់ Backend។
---
