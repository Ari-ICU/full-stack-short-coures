---
title: JSX
description: ស្វែងយល់ពីអ្វីទៅជា JSX ដែលជាការច្របាច់បញ្ចូលគ្នារវាង HTML និង JavaScript អនុញ្ញាតអោយយើងសរសេរកូដ UI បានយ៉ាងមានប្រសិទ្ធភាព។
objectives:
...
quiz:
  - question: "តើច្បាប់មួយណាដែលត្រឹមត្រូវបំផុតនៅពេលសរសេរកូដ JSX?"
    options:
      ...
      - "\"JSX មិនតម្រូវអោយបិទ Tag ទេ (ឧទាហរណ៍ `<img src='logo.png'>` អាចដំណើរការបាន)\""
      - "\"JSX ត្រូវតែមាន Tag មេតែមួយគត់គ្របពីលើគេបង្អស់ (One Top-Level Element)\""
      - "\"យើងអាចប្រើប្រាស់ពាក្យ `class='btn'` ដូច HTML ធម្មតា\""
    correctAnswer: 3
    explanation: "កូដ JSX មិនអាចបញ្ជូនចេញធាតុ (Elements) ពីរទន្ទឹមគ្នាដោយគ្មានការរុំពីក្រៅបានទេ (ឧទាហរណ៍ `return <h1>Hello</h1><h2>World</h2>` គឺខុស!)។ វាត្រូវតែមានធាតុអោបក្រសោបតែមួយ ឫត្រូវប្រើប្រាស់ Fragment `<></>` រុំពីក្រៅ។"
---
