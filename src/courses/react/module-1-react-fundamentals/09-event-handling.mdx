...
description: របៀបចាប់យកសកម្មភាពរបស់អ្នកប្រើប្រាស់ (ចុចប៊ូតុង, វាយអក្សរ) នៅក្នុង React និងការយល់ដឹងពី Event Object។
objectives:
...
order: 9
quiz:
  - question: "តើការសរសេរកូដមួយណាជាទម្រង់ត្រឹមត្រូវសម្រាប់ភ្ជាប់សកម្មភាពចុចប៊ូតុងនៅក្នុង React?"
    options:
      ...
      - "\"<button onClick='handleClick'>Click</button>\""
    correctAnswer: 3
    explanation: "កូដទី ២ គឺជាកំហុសដែលកើតមានច្រើនបំផុត! ការដាក់រង្វង់ក្រចក `()` ពីក្រោយឈ្មោះអនុគមន៍ គឺមានន័យថាអ្នកកំពុងបញ្ជាអោយវាដំណើរការភ្លាមៗ នៅពេលដែលទំព័រទើបតែ Load ចេញមក (មិនទាន់ទាំងមានអ្នកចុចផង)។ វិធីត្រឹមត្រូវគឺ ការបញ្ជូនតែឈ្មោះ (Reference) របស់វាប៉ុណ្ណោះ។"
---
