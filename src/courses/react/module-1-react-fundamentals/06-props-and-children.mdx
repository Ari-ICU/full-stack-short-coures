...
description: រៀនពីរបៀបបញ្ជូនទិន្នន័យឆ្លងកាត់ Components ផ្សេងៗគ្នាដោយប្រើ Props និងស្វែងយល់ពីអត្ថប្រយោជន៍ដ៏អស្ចារ្យនៃ 'children' prop។
objectives:
  - យល់ពីទិសដៅនៃលំហូរទិន្នន័យក្នុង React (One-way Data Flow)
  - ចេះបញ្ជូនទិន្នន័យតាមរយៈ Props និងការធ្វើ Destructuring
  - យល់ពីអត្ថន័យ និងការប្រើប្រាស់ `children` Prop សម្រាប់ការរុំ Components (Wrapper)
...
quiz:
  - question: "តើអ្វីទៅជាច្បាប់ដ៏សំខាន់បំផុតរបស់ Props?"
    options:
      ...
      - "\"Props គឺមានលក្ខណៈ Read-Only (បានត្រឹមតែអានប៉ុណ្ណោះ)! Component កូនមិនអាចផ្លាស់ប្តូរតម្លៃរបស់វាដោយផ្ទាល់បានទេ។\""
      - "\"Props អាចបញ្ជូនទិន្នន័យពី Component កូន ទៅ Component ឪពុកវិញបានដោយផ្ទាល់\""
      - "\"អ្នកអាចប្រើ Props បានតែចំពោះអក្សរ (String) ប៉ុណ្ណោះ\""
    correctAnswer: 2
    explanation: "ច្បាប់ដ៏តឹងរ៉ឹងបំផុតរបស់ React គឺ Props មិនអាចកែប្រែបានទេ (Immutable)! បើ Component កូនចង់អោយទិន្នន័យប្រែប្រួល វាត្រូវហៅអនុគមន៍ (Callback Function) ដើម្បីប្រាប់ទៅឪពុកអោយជាអ្នកកែប្រែវិញ។"
---
