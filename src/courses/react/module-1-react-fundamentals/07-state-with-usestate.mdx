...
description: ស្វែងយល់ពីរបៀបធ្វើអោយវេបសាយរបស់អ្នកមានជីវិត! រៀនពីការរក្សាទុកទិន្នន័យ (State) និងការគូររូបរាងឡើងវិញ (Re-render) ដោយស្វ័យប្រវត្តិ។
objectives:
...
order: 7
quiz:
  - question: "ឧបមាថា `count` គឺ 0។ តើមានអ្វីកើតឡើងប្រសិនបើអ្នកហៅ `setCount(count + 1)` បីដងជាប់ៗគ្នានៅក្នុង Function តែមួយ?"
    options:
      - "\"count នឹងកើនដល់ 3 ភ្លាមៗ\""
      - "\"count នឹងកើនដល់ 3 តែក្រោយពេលវា Render រួច\""
      - "\"count នឹងកើនឡើងត្រឹមតែ 1 ប៉ុណ្ណោះ ព្រោះវាប្រើប្រាស់តម្លៃ 0 ដើម ដើម្បីបូកបញ្ជូលគ្នាក្នុងជុំតែមួយ (Batching)\""
      - "\"កូដនឹងលោត Error\""
    correctAnswer: 3
    explanation: "នេះគឺជាលក្ខណៈពិសេសរបស់ React ហៅថា Batching! ការហៅ `setCount(count + 1)` បីដង គឺប្រៀបដូចជាការប្រាប់ React ថា `setCount(0 + 1)`, `setCount(0 + 1)`, `setCount(0 + 1)` អញ្ចឹងដែរ។ ដើម្បីដោះស្រាយបញ្ហានេះ អ្នកត្រូវប្រើ Functional Updates: `setCount(prev => prev + 1)`។"
---
