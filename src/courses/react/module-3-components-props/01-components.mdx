...
description: >-
  រៀនពីបេះដូងរបស់ React គឺការបំបែក UI ទៅជាបំណែកតូចៗ (Components)
  និងការយកវាមកផ្គុំចូលគ្នាវិញ (Composition)។
objectives:
...
quiz:
  - question: >-
      តើច្បាប់មួយណាជាច្បាប់ទូទៅ (Convention) សម្រាប់ការដាក់ឈ្មោះអោយ React
      Component?
    options:
    ...
    correctAnswer: 2
    explanation: >-
      React ត្រូវការអោយឈ្មោះ Component ផ្តើមដោយអក្សរធំជានិច្ច (PascalCase)
      ដើម្បីបែងចែកវាពី HTML Tag ធម្មតា។ ប្រសិនបើអ្នកសរសេរ `<button>` វាដឹងថាជា
      HTML តែបើអ្នកសរសេរ `<Button>` វាដឹងថាជា Component ដែលអ្នកបង្កើត!
---
