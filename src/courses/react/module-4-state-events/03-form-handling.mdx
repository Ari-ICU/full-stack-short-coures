...
description: >-
  រៀនពីបច្ចេកទេស 'Controlled Components' ដើម្បីគ្រប់គ្រង Form Inputs (Text,
  Checkbox, Select) ទាំងអស់ និងការត្រួតពិនិត្យភាពត្រឹមត្រូវ (Validation)។
objectives:
...
quiz:
  - question: >-
      តើអនុគមន៍អ្វីដែលអ្នកត្រូវហៅនៅខាងក្នុង `onSubmit` ដើម្បីការពារកុំអោយ
      Browser ធ្វើការ Refresh ទំព័រទាំងមូលនៅពេលអ្នកចុច Submit Form?
    options:
      - '"e.stopPropagation()"'
      - '"e.preventDefault()"'
      - '"e.cancelSubmission()"'
    ...
    correctAnswer: 2
    explanation: >-
      ជាលំនាំដើមរបស់ HTML ពេលអ្នកចុច Submit នៅក្នុង Form វានឹងធ្វើការ Refresh
      ទំព័រវេបសាយ (ដែលខុសនឹងគោលការណ៍របស់ SPA)។ ដូច្នេះ អ្នកត្រូវតែហៅ
      `e.preventDefault()` ជានិច្ច ដើម្បីទប់ស្កាត់វា និងអនុញ្ញាតអោយកូដ React
      ដំណើរការការងារបន្ត។
---
