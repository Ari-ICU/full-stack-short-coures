...
description: >-
  ស្វែងយល់ពីរបៀបរក្សាទុកទិន្នន័យសម្ងាត់ ឬ ការកំណត់រចនាសម្ព័ន្ធ (Configuration)
  ដោយប្រើប្រាស់ឯកសារ .env នៅក្នុងគម្រោង Vite។
objectives:
...
quiz:
  - question: >-
      ប្រសិនបើអ្នកមានឯកសារ `.env` មួយនៅក្នុងគម្រោង React របស់អ្នក
      តើកូដខាងក្រោមនេះមានសុវត្ថិភាពដែរឬទេ? `VITE_PAYMENT_API_KEY=sk_test_12345`
    options:
      - '"មានសុវត្ថិភាព ព្រោះ Vite បានលាក់វាមិនអោយអ្នកប្រើប្រាស់ឃើញឡើយ"'
      - >-
        "មិនមានសុវត្ថិភាពទេ! រាល់អថេរដែលត្រូវបានប្រើប្រាស់ដោយ Frontend
        (បើទោះជាមានអក្សរ VITE_ ពីមុខក៏ដោយ) នឹងត្រូវបញ្ជូលទៅក្នុងកូដ JavaScript
        ដែលអ្នកប្រើប្រាស់អាចបើកមើលបានយ៉ាងងាយស្រួល។"
      - '"មានសុវត្ថិភាព លុះត្រាតែយើងដាក់វាក្នុង `.env.local`"'
      - '"មានសុវត្ថិភាព ព្រោះវាជា HTTPS"'
    correctAnswer: 2
    explanation: >-
      នេះគឺជាការយល់ច្រឡំដ៏ធំបំផុតនៅក្នុងសហគមន៍! Frontend (React) រត់នៅលើ Browser
      របស់អតិថិជន។ អ្វីក៏ដោយដែលវាអាចអានបាន អតិថិជនក៏អាចអានបានដែរ (ដោយគ្រាន់តែចុច
      Inspect Element)។ កុំប្រើ `.env` ដើម្បីលាក់ Secret Keys ពិតប្រាកដអោយសោះ!
      វាគ្រាន់តែជាកន្លែងសម្រាប់ទុក Config (ដូចជា URL របស់ API) ប៉ុណ្ណោះ។
---
