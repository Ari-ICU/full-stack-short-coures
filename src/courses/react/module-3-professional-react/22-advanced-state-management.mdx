...
description: នៅពេលដែល Context API លែងមានប្រសិទ្ធភាពសម្រាប់គម្រោងធំៗ ដល់ពេលដែលអ្នកត្រូវស្គាល់ពីបណ្ណាល័យគ្រប់គ្រង State អាជីពដូចជា Zustand ឫ Redux Toolkit។
objectives:
...
order: 22
quiz:
  - question: "ហេតុអ្វីបានជាយើងមិនគួរប្រើប្រាស់ React Context ជា 'Global State' សម្រាប់គ្រប់ទិន្នន័យទាំងអស់ (ដូចជាទិន្នន័យ Form ដែលវាយញឹកញាប់)?"
    options:
      - "\"ព្រោះ Context អាចផ្ទុកបានត្រឹមតែអក្សរប៉ុណ្ណោះ\""
      - "\"ព្រោះរាល់ពេលទិន្នន័យក្នុង Context ប្រែប្រួល ទោះបន្តិចបន្តួចក៏ដោយ រាល់ Component ទាំងអស់ដែលតភ្ជាប់ជាមួយវានឹងត្រូវ Re-render (គូរឡើងវិញ) ទាំងស្រុង ដែលធ្វើអោយវេបសាយដើរយឺតខ្លាំង។\""
      - "\"ព្រោះ Context មានតម្លៃថ្លៃ\""
      - "\"ព្រោះវាជាបច្ចេកវិទ្យាហួសសម័យ\""
    correctAnswer: 2
    explanation: "Context មិនមានសមត្ថភាព 'ជ្រើសរើស (Select)' ទិន្នន័យដាច់ដោយឡែកនោះទេ។ បើអ្នកមានទិន្នន័យ {name: 'A', age: 20} ហើយអ្នកប្តូរតែ name រាល់ Component ដែលប្រើប្រាស់អថេរ age ក៏ត្រូវបង្ខំចិត្ត Re-render ឡើងវិញដោយឥតប្រយោជន៍ដែរ! នេះជាមូលហេតុដែល Zustand/Redux ត្រូវបានបង្កើតឡើង។"
---
