...
ការធ្វើបែបនេះគឺហត់នឿយខ្លាំងណាស់! ឥឡូវនេះ Next.js បានណែនាំ **Server Actions** ដែលលុបបំបាត់ API និង `fetch` ចោលទាំងស្រុង! អ្នកអាចហៅ Function របស់ Server បានដោយផ្ទាល់ពីកូដ Client។
