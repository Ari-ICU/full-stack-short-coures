...
const MODULE_TITLES: Record<string, string> = {
  ...
  "module-5-libraries": "Module 5 — Working with Libraries",
  "module-1-react": "Module 1 — React Fundamentals",
  "module-1-setup": "Module 1 — Introduction & Setup",
  "module-2-components-props": "Module 2 — Components, Props & UI Rendering",
  "module-3-state-events": "Module 3 — State & Event Handling",
  "module-4-effects-lifecycle": "Module 4 — Side Effects & Component Lifecycle",
  "module-5-global-state": "Module 5 — Global State Management & Context API",
  "module-6-routing": "Module 6 — Routing & Navigation",
  "module-7-advanced": "Module 7 — Advanced Concepts & Optimization",
  "module-8-styling": "Module 8 — UI & Styling in React",
  "module-1-nextjs": "Module 1 — Next.js & App Router",
