...
const MODULE_TITLES: Record<string, string> = {
  ...
  "module-2-styling": "Module 2 — UI & Styling in React",
  "module-3-components-props": "Module 3 — Components, Props & UI Rendering",
  "module-4-state-events": "Module 4 — State & Event Handling",
  "module-5-effects-lifecycle": "Module 5 — Side Effects & Component Lifecycle",
  "module-6-global-state": "Module 6 — Global State Management & Context API",
  "module-7-routing": "Module 7 — Routing & Navigation",
  "module-8-advanced": "Module 8 — Advanced Concepts & Optimization",
